...
@test "Test if GitLab repository is created." {
	...
	ensure_new_empty_repo_is_created_in_gitlab "$PUBLIC_GITHUB_TEST_REPO_GLOBAL" "$gitlab_username"
...
@test "GitLab repo is found if it exists." {
	...
	ensure_new_empty_repo_is_created_in_gitlab "$test_repo_name" "$gitlab_username"
...
@test "GitLab repo is found if it is created." {
	...
	ensure_new_empty_repo_is_created_in_gitlab "non-existing-repository" "$gitlab_username" 
	output=$(gitlab_mirror_repo_exists_in_gitlab "non-existing-repository")
